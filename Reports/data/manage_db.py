...
def cmd_init(args=None):
    ...
    companies = [
        ("1904", "正隆", "2026-07", 42.56, 9.75, 22.82, 263.63, None, "創近19個月新高，平陽三期投產放量"),
        ("1909", "榮成", "2026-07", 43.24, None, 20.32, 285.35, 4.29, "前7月自結稅前轉虧為盈達4.29億元，8/12暫停交易"),
        ("1907", "永豐餘", "2026-07", 64.51, None, 7.28, None, None, "氣候目標與碳管理佈局效益顯現"),
        ("1905", "華紙", "2026-07", 15.20, None, 1.48, 106.00, None, "綠能與無塑防油卡紙出貨平穩")
    ]
    for c in companies:
        cursor.execute("""
    ...
    VALUES ('REG_EU_PPWR', '歐盟包裝與包裝廢棄物法規強制生效', 'REGULATION', 'EU', '2026-08-12', 0, 'ACTIVE', '歐盟PPWR法規2026-08-12正式適用，全歐包裝可回收性驗證與DPP全面啟動', 'EUR-Lex', 'https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R0000')
